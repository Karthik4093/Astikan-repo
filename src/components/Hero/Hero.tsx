      ...
      <div className="container-page grid items-center gap-12 lg:grid-cols-[1.05fr_.95fr]">
        <div data-aos="fade-up">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <a href="#health-pocket" className="gradient-button">Get Your Health Card</a>
            <a href="#premium-calculator" className="outline-button">Calculate Premium</a>
          </div>
          <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
            {stats.map((stat) => (
              <div key={stat.label} className="card p-6 text-center" data-aos="zoom-in">
